...
import roamingComposedChart from './Roaming/roamingComposedChart'
import roamingList from './Roaming/roamingList'
import callComposedChart from './Call/callComposedChart'
  ...
  render () {
    return (
      <div className="App">
        ...
        <Route path='/roamingComposedChart' component={roamingComposedChart} />
        <Route path='/roamingList' component={roamingList} />
        <Route path='/callComposedChart' component={callComposedChart} />
